        ...
        <main class="row">
            <section class="col-md-12">
                <div class="content-block">
                    <h1 class="content-title">Добавление новости</h1>
                    <form class="admin-form" action="{{ route('add-news') }}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="text" name="title" placeholder="Название" required>
                        <textarea name="desc" class="tinymce-editor news-editor"></textarea>
